...
# WARNING: Many Sphinx examples show this path setup step
# but we know altering sys.path is not a good idea.
# We don't need to do this if we have installed package
# into the venv running sphinx.
sys.path.insert(0, os.path.abspath("../../src"))


# -- Project information -----------------------------------------------------
project = "AM215 Quality Demo"
copyright = "2025, The AM215 Team"
